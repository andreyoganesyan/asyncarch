...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private final KTable<UUID, UserPrincipal> userKTable;
    private final StreamsBuilderFactoryBean streamsBuilder;

    public JwtAuthFilter(@Value("security.jwt.secret") String jwtSecret, KTable<UUID, UserPrincipal> userKTable, StreamsBuilderFactoryBean streamsBuilder) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        var userStore = kafkaStreams.store(StoreQueryParameters.fromNameAndType(this.userKTable.queryableStoreName(), QueryableStoreTypes.<UUID, UserPrincipal>keyValueStore()));
        ...
        try {
            ...
            UserPrincipal user = userStore.get(UUID.fromString(decodedJwt.getSubject()));
            if (user != null) {
